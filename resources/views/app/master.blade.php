...
<div class="nav-header text-center" style="background: #000 !important; background-image: none !important; font-family: 'Poppins', sans-serif; display: flex; align-items: center; justify-content: center; height: 70px;">
    ...
    <div class="footer">
        <div class="copyright">
            <p>Copyright &copy; Aplikasi Pengelola Keuangan. by Anomaly Tech {{ date('Y') }}</p>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#table-datatable-kapal').DataTable({
            'paging'      : true,
            'lengthChange': true,
            'searching'   : true,
            'ordering'    : true,
        ...
        $('#table-datatable-muatan').DataTable({
            'paging'      : true,
            'lengthChange': true,
            'searching'   : true,
            'ordering'    : true,
        ...
        $('#table-datatable-rute').DataTable({
            'paging'      : true,
            'lengthChange': true,
            'searching'   : true,
            'ordering'    : true,
